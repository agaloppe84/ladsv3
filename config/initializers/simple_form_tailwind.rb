...
SimpleForm.setup do |config|
  ...
  config.label_class = 'text-sm font-medium leading-6 text-gray-900'
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'mb-4' do |b|
    ...
    b.use :input, class: 'mt-2 shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white focus:outline-none focus:ring-0 focus:border-blue-500 text-gray-400 leading-6 transition-colors duration-200 ease-in-out', error_class: 'border-red-500', valid_class: 'border-green-400'
  ...
  config.wrappers :vertical_boolean, tag: 'div', class: 'mb-4 flex items-start items-center', error_class: '' do |b|
    b.use :html5
    b.optional :readonly
