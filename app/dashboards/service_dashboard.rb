...
class ServiceDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    custom_dimensions: Field::Boolean,
    free_quote: Field::Boolean,
    anti_fire: Field::Boolean,
    made_in_france: Field::Boolean,
    anti_uv: Field::Boolean,
    rge: Field::Boolean,
    wind_resistance: Field::Boolean,
