    ...
    module ExplodedView
      class BaseDrawingComponent < ViewComponent::Base
        ...
        FABRIC_PATTERN_ROLE_CLASSES = {
          ...
          fabric_duo_band_mid: "pv2-product-exploded__fabric-duo-band pv2-product-exploded__fabric-duo-band--mid",
          fabric_duo_sheer: "pv2-product-exploded__fabric-duo-sheer",
          fabric_honeycomb_edge: "pv2-product-exploded__fabric-honeycomb-edge",
          fabric_honeycomb_face_deep: "pv2-product-exploded__fabric-honeycomb-face pv2-product-exploded__fabric-honeycomb-face--deep",
          fabric_honeycomb_face_light: "pv2-product-exploded__fabric-honeycomb-face pv2-product-exploded__fabric-honeycomb-face--light",
          fabric_honeycomb_face_mid: "pv2-product-exploded__fabric-honeycomb-face pv2-product-exploded__fabric-honeycomb-face--mid",
          fabric_honeycomb_recess: "pv2-product-exploded__fabric-honeycomb-recess",
          fabric_honeycomb_thread: "pv2-product-exploded__fabric-honeycomb-thread",
